...
public class TileManager {
    ...
    GamePanel gp;
    public Tile[] tile;
    public int mapTileNum[][];  // Define tile map matrix
    ...
    public void getTileImage() {
        ...
        try {
            ...
            tile[1].collision = true;  // Set as solid tile

            tile[2] = new Tile();
            tile[2].image = ImageIO.read(getClass().getResourceAsStream("/tiles/water01.png"));
            tile[2].collision = true;  // Set as solid tile
            ...
            tile[4].collision = true;  // Set as solid tile
